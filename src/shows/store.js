...
export const fetchShowMainInfo = createAsyncThunk(`${PREFIX}/fetchShowMainInfo`, async (showId, thunkAPI) => {
    const result = await thunkAPI.extra.showsService.getShowMainInformation(showId);
    return result.data;
});
